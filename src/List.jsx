const List = ({jobList,onHandleItem ,}) => {
...
<p className="bg-NGreen-50 text-PGreen-400 px-3 py-1 cursor-pointer active:bg-NGreen-900 active:text-PGreen-400 " onClick={() => onHandleItem(job.role)}> {job?.role}</p>

<p className="bg-NGreen-50 text-PGreen-400 px-3 py-1  cursor-pointer active:bg-NGreen-900 active:text-PGreen-400" onClick={() =>onHandleItem(job.level)}>
{job?.level}
</p>
{job?.languages.map((language,index) => (
<p key={index}className="bg-NGreen-50 text-PGreen-400 px-3 py-1 cursor-pointer active:bg-NGreen-900 active:text-PGreen-400"  onClick={() =>onHandleItem(language)}>{language}</p>
))}

{job?.tools.map((tool,index) => (
<p key={index} className="bg-NGreen-50 text-PGreen-400 px-3 py-1 cursor-pointer active:bg-NGreen-900 active:text-PGreen-400 "  onClick={() =>onHandleItem(tool)}>{tool}</p>
))}
